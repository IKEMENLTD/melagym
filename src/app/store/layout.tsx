  ...
  const handleLogin = useCallback(
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        setStoreAuth(data.store.id, data.store.name);
    ...
    return (
      <div className="min-h-screen bg-[#f0f0f0] flex items-center justify-center p-4">
        <form onSubmit={handleLogin} className="bg-white p-8 w-full max-w-sm space-y-4 shadow-sm">
          ...
          <p className="text-center text-sm text-[#606060]">店舗ログイン</p>

          {authError && (
            <p className="text-sm text-[#ef4444] text-center">{authError}</p>
          )}
          ...
          {optionsLoading ? (
            ...
            <select
              ...
              className="w-full px-4 py-3 border border-[#d9d9d9] text-sm bg-white text-[#4d4d4d]"
            >
          ...
          <button
            type="submit"
            disabled={!selectedStoreName || authLoading}
    ...
    <div className="min-h-screen bg-[#f0f0f0] flex">
      ...
      <aside className="w-64 bg-white border-r border-[#d9d9d9] hidden md:flex md:flex-col">
        <div className="p-6">
          ...
          <p className="text-xs text-[#606060] mt-1">{storeName}</p>
        </div>
          ...
          <div className="flex items-center justify-between px-4 py-3">
            <div className="flex items-center gap-2">
              <Image
                ...
                height={56}
              />
              <span className="text-xs text-[#606060]">{storeName}</span>
            </div>
            <button
